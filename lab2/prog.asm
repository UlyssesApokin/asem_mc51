...
ecw		equ p0.2	;движение перекл-я по ч.с. (engine clockwise)
eccw	equ p0.3	;движение перкл-я против ч.с. (engine counterclockwise)
conv	equ p0.4	;движение конвейера с заготовками
;------------------------------------------------------------------------------
std		equ p2		;вывод МК для сообщения об ошибках и выводе информации
					;ИСП-ТЬ ТОЛЬКО ПИНЫ 0 -- 3 !
;------------------------------------------------------------------------------
d1		equ p1.4	;датчик d1 (кол-во заготовок)
d2		equ p1.5	;датчик d2 (первое положение)
d3		equ p1.6	;датчик d3 (второе положение)
d4		equ p1.7	;датчик d4 (третье положение)
